...
namespace gatbl {
/** While waiting for real concepts adoption in compiler this library proposeto use template function signature to express requirement on type.
 *
...
/// eg: template<typename R> R func(..., proxy_t<R>={}); allows to chose overload's return type with func(..., proxy_t<return_t>{})
